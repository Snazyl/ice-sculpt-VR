...
public class Cut : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Material bladeMaterial = Instantiate(_blade.GetComponent<MeshRenderer>().material);
        // _blade.GetComponent<MeshRenderer>().material = bladeMaterial;

        _vertices = new Vector3[3 * NUM_VERTICES];
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        //Align the normal with the transform of the sliced object
        Vector3 transformedNormal = ((Vector3)(other.gameObject.transform.localToWorldMatrix.transpose * normal)).normalized;

        //Get the enter position relative to the sliced object's local transform
